...
internal class DatabaseInitializer : IDatabaseInitializer
{
    ...
    public async Task InitializeApplicationDbForTenantAsync(RAFFLETenantInfo tenant, CancellationToken cancellationToken)
    {
    ...
    private async Task SeedRootTenantAsync(CancellationToken cancellationToken)
    {
        ...
        {
            var rootTenant = new RAFFLETenantInfo(
