...
public class UsersController : VersionNeutralApiController
{
    ...
    [HttpGet("{id}/roles")]
    [MustHavePermission(RAFFLEAction.View, RAFFLEResource.UserRoles)]
    ...
    [MustHavePermission(RAFFLEAction.Update, RAFFLEResource.UserRoles)]
    ...
    [HttpPost]
    [MustHavePermission(RAFFLEAction.Create, RAFFLEResource.Users)]
    ...
    [MustHavePermission(RAFFLEAction.Update, RAFFLEResource.Users)]
    [ApiConventionMethod(typeof(RAFFLEApiConventions), nameof(RAFFLEApiConventions.Register))]
